...
<div class="blog">
    <div class="blog-left">
        ...
        <div class="blog-left-content">
            ...
            $query1="select count(*) as total from cssbloginfo order by id desc";
            ...
            $sql1=@mysql_query("select * from cssbloginfo order by id desc limit $offset1, $page_size1");
                ...
                <table class="table"  width="550" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <td width="50%" align="right">
                            ...
                            if($page1!=1){
                                /*  显示“首页”超链接  */
                                echo  "<a style='color:black;' href='blogcss.php?page1=1'>首页</a>&nbsp;";
                                /*  显示“上一页”超链接  */
                                echo "<a style='color:black;'  href=blogcss.php?page1=".($page1-1).">上一页</a>&nbsp;";
                            }
                            /*  如果当前页不是尾页  */
                            if($page1<$page_count1){
                                /*  显示“下一页”超链接  */
                                echo "<a style='color:black;'  href=blogcss.php?page1=".($page1+1).">下一页</a>&nbsp;";
                                /*  显示“尾页”超链接  */
                                echo  "<a style='color:black;'  href=blogcss.php?page1=".$page_count1.">尾页</a>";
                            }
